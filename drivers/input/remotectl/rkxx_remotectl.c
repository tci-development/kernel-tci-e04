...
static struct rkxx_remote_key_table remote_key_table_sears[] = {
		  {0x2, KEY_HOME},
		  {0x82, KEY_SEARCH},
		  {0x78, KEY_BACK},
		  {0x42, KEY_MENU},		
	         {0xb0, KEY_UP},
		  {0xc2, KEY_POWER},   // KEY_BRIGHTNESS_CYCLE
		  {0xc0, KEY_LEFT},
		  {0x60, KEY_ENTER},  //KEY_REPLY
         	  {0x50, KEY_RIGHT},
		  {0x22, KEY_VOLUMEDOWN},
		  {0x58, KEY_DOWN},
                {0xa2, KEY_VOLUMEUP},
    		  ...
    		  //media ctrl
		  {0x62,   KEY_FASTFORWARD},      //fast forward
                {0x92,   KEY_MUTE},      //mute
    		  {0xa,   KEY_REWIND},      //back forward
    		  {0x8a,   KEY_PLAYPAUSE},      //play pause
    		  {0x4a,   KEY_PREVIOUS},      //pre
    		  {0xca,   KEY_NEXT},      //next            
 };
...
static struct rkxx_remotectl_button remotectl_button[] = 
{
  {  
       .usercode = 0xff, 
       .nbuttons =  18, 
       .key_table = &remote_key_table_sears[0],
    },
/*  {
       .usercode = 0xff,
       .nbuttons =  13,
